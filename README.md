...
```javascript
example = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-code-blocks@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/repl-code-blocks/tags). For example,

```javascript
example = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-code-blocks@v0.5.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var example = require( 'path/to/vendor/umd/repl-code-blocks/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/repl-code-blocks/actions/workflows/test.yml/badge.svg?branch=v0.5.0
[test-url]: https://github.com/stdlib-js/repl-code-blocks/actions/workflows/test.yml?query=branch:v0.5.0
...
[deno-readme]: https://github.com/stdlib-js/repl-code-blocks/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/repl-code-blocks/tree/umd
[umd-readme]: https://github.com/stdlib-js/repl-code-blocks/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/repl-code-blocks/tree/esm
[esm-readme]: https://github.com/stdlib-js/repl-code-blocks/blob/esm/README.md
