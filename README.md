...
```javascript
example = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-code-blocks@vnull-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/repl-code-blocks/actions/workflows/test.yml/badge.svg?branch=vnull
[test-url]: https://github.com/stdlib-js/repl-code-blocks/actions/workflows/test.yml?query=branch:vnull
